...
function App() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://crud7-4obh.onrender.com/items', {
        method: 'GET',
        headers: {
  ...
  const handleInsertItem = async () => {
    try {
      ...
      const response = await fetch('https://crud7-4obh.onrender.com/insert', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleGenerateSuggestion = async () => {
    try {
      const response = await fetch('https://crud7-4obh.onrender.com/suggestions', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
